...
int main(int argc, char *argv[])
{
    ...
    rslt = bma423_map_interrupt(BMA4_INTR1_MAP, BMA4_DATA_RDY_INT, BMA4_ENABLE, &bma4);
    ...
    rslt = bma423_get_remap_axes(&remap_data, &bma4);
    bma4_error_codes_print_result("bma423_get_remap_axes", rslt);
    ...
    while (1)
    {
        ...
        rslt = bma423_read_int_status(&int_status, &bma4);
    ...
    rslt = bma423_set_remap_axes(&remap_data, &bma4);
