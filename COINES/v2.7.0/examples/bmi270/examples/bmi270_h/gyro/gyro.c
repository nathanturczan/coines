        ...
        if (rslt == BMI2_OK)
        {
            ...
            while (indx <= limit)
            {
                ...
                if ((rslt == BMI2_OK) && (sensor_data.status & BMI2_DRDY_GYR))
                {
                    ...
                    x = lsb_to_dps(sensor_data.gyr.x, 2000, bmi.resolution);
                    y = lsb_to_dps(sensor_data.gyr.y, 2000, bmi.resolution);
                    z = lsb_to_dps(sensor_data.gyr.z, 2000, bmi.resolution);
