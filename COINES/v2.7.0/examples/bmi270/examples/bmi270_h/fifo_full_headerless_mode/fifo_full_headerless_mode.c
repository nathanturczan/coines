...
#define BMI270_H_FIFO_RAW_DATA_BUFFER_SIZE  UINT16_C(2048)

/*! Length of data to be read from FIFO */
#define BMI270_H_FIFO_RAW_DATA_USER_LENGTH  UINT16_C(2048)
 ...
 */
#define BMI270_H_FIFO_ACCEL_FRAME_COUNT     UINT8_C(169)

/*! Number of gyro frames to be extracted from FIFO */
#define BMI270_H_FIFO_GYRO_FRAME_COUNT      UINT8_C(169)
