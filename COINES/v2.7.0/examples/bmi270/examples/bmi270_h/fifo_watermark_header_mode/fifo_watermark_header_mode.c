...
#define BMI270_H_FIFO_RAW_DATA_BUFFER_SIZE  UINT16_C(1200)

/*! Length of data to be read from FIFO */
#define BMI270_H_FIFO_RAW_DATA_USER_LENGTH  UINT16_C(1200)
...
#define SENSORTIME_OVERHEAD_BYTE            UINT8_C(180)
...
int main(void)
{
    ...
    uint16_t fifo_buffer_size = BMI270_H_FIFO_RAW_DATA_BUFFER_SIZE + SENSORTIME_OVERHEAD_BYTE;
    ...
    fifoframe.length = BMI270_H_FIFO_RAW_DATA_USER_LENGTH + SENSORTIME_OVERHEAD_BYTE;
