 ...
 *  @retval = BMI090L_INTF_RET_SUCCESS -> Success
 *  @retval != BMI090L_INTF_RET_SUCCESS  -> Failure Info
 *
 */
 ...
 *
 *  @param[in] bma      : Structure instance of bmi090l_dev
 ...
 */
int8_t bmi090l_interface_init(struct bmi090l_dev *bma, uint8_t intf);
